...
int __sys_setsockopt(int fd, int level, int optname, char __user *optval,
		int optlen);
asmlinkage long sys_init_kern_application(void);
asmlinkage long sys_free_kern_application(void);
asmlinkage long sys_kern_add_priority(queue_node_421_t __user *node);
asmlinkage long sys_kern_get_priority(queue_node_421_t __user *dest);
#endif
