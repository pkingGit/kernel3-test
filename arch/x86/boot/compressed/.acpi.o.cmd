cmd_arch/x86/boot/compressed/acpi.o := gcc -Wp,-MMD,arch/x86/boot/compressed/.acpi.o.d -nostdinc -isystem /usr/lib/gcc/x86_64-linux-gnu/10/include -I./arch/x86/include -I./arch/x86/include/generated  -I./include -I./arch/x86/include/uapi -I./arch/x86/include/generated/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/compiler-version.h -include ./include/linux/kconfig.h -include ./include/linux/compiler_types.h -D__KERNEL__ -fmacro-prefix-map=./= -m64 -O2 -fno-strict-aliasing -fPIE -Wundef -DDISABLE_BRANCH_PROFILING -mcmodel=small -mno-red-zone -mno-mmx -mno-sse -ffreestanding -fshort-wchar -fno-stack-protector -Wno-address-of-packed-member -Wno-pointer-sign -fmacro-prefix-map=./= -fno-asynchronous-unwind-tables -D__DISABLE_EXPORTS -Wa,-mrelax-relocations=no -include ./include/linux/hidden.h    -DKBUILD_MODFILE='"arch/x86/boot/compressed/acpi"' -DKBUILD_BASENAME='"acpi"' -DKBUILD_MODNAME='"acpi"' -D__KBUILD_MODNAME=kmod_acpi -c -o arch/x86/boot/compressed/acpi.o arch/x86/boot/compressed/acpi.c

source_arch/x86/boot/compressed/acpi.o := arch/x86/boot/compressed/acpi.c

deps_arch/x86/boot/compressed/acpi.o := \
...
arch/x86/boot/compressed/acpi.o: $(deps_arch/x86/boot/compressed/acpi.o)
