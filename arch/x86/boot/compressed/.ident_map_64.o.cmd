cmd_arch/x86/boot/compressed/ident_map_64.o := gcc -Wp,-MMD,arch/x86/boot/compressed/.ident_map_64.o.d -nostdinc -isystem /usr/lib/gcc/x86_64-linux-gnu/10/include -I./arch/x86/include -I./arch/x86/include/generated  -I./include -I./arch/x86/include/uapi -I./arch/x86/include/generated/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/compiler-version.h -include ./include/linux/kconfig.h -include ./include/linux/compiler_types.h -D__KERNEL__ -fmacro-prefix-map=./= -m64 -O2 -fno-strict-aliasing -fPIE -Wundef -DDISABLE_BRANCH_PROFILING -mcmodel=small -mno-red-zone -mno-mmx -mno-sse -ffreestanding -fshort-wchar -fno-stack-protector -Wno-address-of-packed-member -Wno-pointer-sign -fmacro-prefix-map=./= -fno-asynchronous-unwind-tables -D__DISABLE_EXPORTS -Wa,-mrelax-relocations=no -include ./include/linux/hidden.h    -DKBUILD_MODFILE='"arch/x86/boot/compressed/ident_map_64"' -DKBUILD_BASENAME='"ident_map_64"' -DKBUILD_MODNAME='"ident_map_64"' -D__KBUILD_MODNAME=kmod_ident_map_64 -c -o arch/x86/boot/compressed/ident_map_64.o arch/x86/boot/compressed/ident_map_64.c

source_arch/x86/boot/compressed/ident_map_64.o := arch/x86/boot/compressed/ident_map_64.c

deps_arch/x86/boot/compressed/ident_map_64.o := \
  ...
  arch/x86/boot/compressed/../../mm/ident_map.c \
  arch/x86/include/asm/setup.h \
    $(wildcard include/config/X86_INTEL_MID) \
    $(wildcard include/config/X86_INTEL_CE) \
  arch/x86/include/uapi/asm/setup.h \

arch/x86/boot/compressed/ident_map_64.o: $(deps_arch/x86/boot/compressed/ident_map_64.o)
