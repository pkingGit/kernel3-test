...
#define __NR_init_kern_application (__X32_SYSCALL_BIT + 600)
#define __NR_free_kern_application (__X32_SYSCALL_BIT + 601)
#define __NR_kern_add_priority (__X32_SYSCALL_BIT + 602)
#define __NR_kern_get_priority (__X32_SYSCALL_BIT + 603)

#ifdef __KERNEL__
#define __NR_syscalls 604
#endif
