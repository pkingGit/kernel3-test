...
__SYSCALL(512, compat_sys_rt_sigaction)
__SYSCALL(513, compat_sys_x32_rt_sigreturn)
__SYSCALL(514, compat_sys_ioctl)
__SYSCALL(515, sys_readv)
__SYSCALL(516, sys_writev)
__SYSCALL(517, compat_sys_recvfrom)
__SYSCALL(518, compat_sys_sendmsg)
__SYSCALL(519, compat_sys_recvmsg)
__SYSCALL(520, compat_sys_execve)
__SYSCALL(521, compat_sys_ptrace)
__SYSCALL(522, compat_sys_rt_sigpending)
__SYSCALL(523, compat_sys_rt_sigtimedwait_time64)
__SYSCALL(524, compat_sys_rt_sigqueueinfo)
__SYSCALL(525, compat_sys_sigaltstack)
__SYSCALL(526, compat_sys_timer_create)
__SYSCALL(527, compat_sys_mq_notify)
__SYSCALL(528, compat_sys_kexec_load)
__SYSCALL(529, compat_sys_waitid)
__SYSCALL(530, compat_sys_set_robust_list)
__SYSCALL(531, compat_sys_get_robust_list)
__SYSCALL(532, sys_vmsplice)
__SYSCALL(533, sys_move_pages)
__SYSCALL(534, compat_sys_preadv64)
__SYSCALL(535, compat_sys_pwritev64)
__SYSCALL(536, compat_sys_rt_tgsigqueueinfo)
__SYSCALL(537, compat_sys_recvmmsg_time64)
__SYSCALL(538, compat_sys_sendmmsg)
__SYSCALL(539, sys_process_vm_readv)
__SYSCALL(540, sys_process_vm_writev)
__SYSCALL(541, sys_setsockopt)
__SYSCALL(542, sys_getsockopt)
__SYSCALL(543, compat_sys_io_setup)
__SYSCALL(544, compat_sys_io_submit)
__SYSCALL(545, compat_sys_execveat)
__SYSCALL(546, compat_sys_preadv64v2)
__SYSCALL(547, compat_sys_pwritev64v2)
__SYSCALL(548, sys_ni_syscall)
__SYSCALL(549, sys_ni_syscall)
__SYSCALL(550, sys_ni_syscall)
__SYSCALL(551, sys_ni_syscall)
__SYSCALL(552, sys_ni_syscall)
__SYSCALL(553, sys_ni_syscall)
__SYSCALL(554, sys_ni_syscall)
__SYSCALL(555, sys_ni_syscall)
__SYSCALL(556, sys_ni_syscall)
__SYSCALL(557, sys_ni_syscall)
__SYSCALL(558, sys_ni_syscall)
__SYSCALL(559, sys_ni_syscall)
__SYSCALL(560, sys_ni_syscall)
__SYSCALL(561, sys_ni_syscall)
__SYSCALL(562, sys_ni_syscall)
__SYSCALL(563, sys_ni_syscall)
__SYSCALL(564, sys_ni_syscall)
__SYSCALL(565, sys_ni_syscall)
__SYSCALL(566, sys_ni_syscall)
__SYSCALL(567, sys_ni_syscall)
__SYSCALL(568, sys_ni_syscall)
__SYSCALL(569, sys_ni_syscall)
__SYSCALL(570, sys_ni_syscall)
__SYSCALL(571, sys_ni_syscall)
__SYSCALL(572, sys_ni_syscall)
__SYSCALL(573, sys_ni_syscall)
__SYSCALL(574, sys_ni_syscall)
__SYSCALL(575, sys_ni_syscall)
__SYSCALL(576, sys_ni_syscall)
__SYSCALL(577, sys_ni_syscall)
__SYSCALL(578, sys_ni_syscall)
__SYSCALL(579, sys_ni_syscall)
__SYSCALL(580, sys_ni_syscall)
__SYSCALL(581, sys_ni_syscall)
__SYSCALL(582, sys_ni_syscall)
__SYSCALL(583, sys_ni_syscall)
__SYSCALL(584, sys_ni_syscall)
__SYSCALL(585, sys_ni_syscall)
__SYSCALL(586, sys_ni_syscall)
__SYSCALL(587, sys_ni_syscall)
__SYSCALL(588, sys_ni_syscall)
__SYSCALL(589, sys_ni_syscall)
__SYSCALL(590, sys_ni_syscall)
__SYSCALL(591, sys_ni_syscall)
__SYSCALL(592, sys_ni_syscall)
__SYSCALL(593, sys_ni_syscall)
__SYSCALL(594, sys_ni_syscall)
__SYSCALL(595, sys_ni_syscall)
__SYSCALL(596, sys_ni_syscall)
__SYSCALL(597, sys_ni_syscall)
__SYSCALL(598, sys_ni_syscall)
__SYSCALL(599, sys_ni_syscall)
__SYSCALL(600, sys_init_kern_application)
__SYSCALL(601, sys_free_kern_application)
__SYSCALL(602, sys_kern_add_priority)
__SYSCALL(603, sys_kern_get_priority)
